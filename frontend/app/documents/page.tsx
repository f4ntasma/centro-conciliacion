                ...
                <Card key={caso.id}>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        size="sm"
                        onClick={(e) => { e.stopPropagation(); handleUploadClick(caso.id); }}
                        disabled={uploadingCasoId === caso.id}
                      >
                    ...
                    <CardContent>
                      {docsDelCaso.length === 0 ? (
                        <p className="text-sm text-muted-foreground text-center py-6">
                          No hay documentos para este caso. Usa el botón Subir.
                        </p>
                      ) : (
                        <Table>
                          <TableHeader>
